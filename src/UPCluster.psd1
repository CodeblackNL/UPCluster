#
# Module manifest for module 'UPCluster'
#
...
RootModule = 'UPCluster.psm1'

# Version number of this module.
ModuleVersion = '0.0.0.0'

# ID used to uniquely identify this module
GUID = 'cd012a61-c2bb-4914-942a-1eb097d83eb5'
...
Description = 'UP cluster provides functions for managing an UP-board cluster.'
...
PrivateData = @{
    PSData = @{
        ProjectUri = 'https://github.com/CodeblackNL/UPCluster'
        LicenseUri = 'https://github.com/CodeblackNL/UPCluster/blob/master/LICENSE'
        Tags = @('UP', 'UP-board', 'Service Fabric', 'ServiceFabric', 'Containers', 'Docker', 'DSC')
